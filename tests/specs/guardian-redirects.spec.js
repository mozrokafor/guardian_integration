...
test.describe('guardian redirects', () => {
  ...
  test.describe('Misc redirects', () => {
    ...
    test('Verify redirect for https://vpn.mozilla.org/r/vpn/subscription', async ({
      page,
    }, testInfo) => {
    ...
    test('Verify redirect for https://vpn.mozilla.org/r/vpn/subscriptionBlocked', async ({
      page,
    }) => {
    ...
    test('Verify redirect for https://vpn.mozilla.org/r/vpn/contact', async ({
      page,
    }, testInfo) => {
